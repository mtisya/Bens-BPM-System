...
<title>Ben's | Entry Log Form</title>
<link rel="shortcut icon" HREF="images/logo.jpg" />
<link rel="stylesheet" href="styles/tdoc.css" />
<script src="js/jquery.js"></script>
<script src="js/entrylog.js"></script>
<script src="js/fetchid.js"></script>
</head>
<body>
<?php
...
<tr><th colspan=12><h1>Entry Log Form:</h1></th></tr>
<tr><td align="right">Work Order#</td><td><input type="text" name="workorder" id="workorder"></td><td align="center"><button type="button" align="left" id="insertid">New Workorder ID</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEntry No#</td><td><input type="text" name="entryno" id="entryno"></td></tr>
...
<tr><fieldset id="notify">test</fieldset></tr>
<tr><td></td><td align="right"><button id=entrylog type='button'>Submit</button></td><td align="right" style="padding-right: 5px;"><button id=btnaddlink type='button' disabled>Update</button><button type='button'>Clear</button></td><td align="left"><button id=btnaddlink type='button'>Cancel</button></td></tr>
</table>
</body>
<br/><br/>
<?php
