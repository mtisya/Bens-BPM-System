...
<tr><td></td><td align="right"><button id=entrylog type='button' disabled>Submit</button></td><td align="right" style="padding-right: 5px;"><button id=updatelog type='button'>Update</button><button type='button' id="clear" >Clear</button></td><td align="left"><button id=btnaddlink onblur="<?php echo "header:supportpopup.php"; ?>" type='button'>Cancel</button></td></tr>
</table>
</body>
<br/><br/>
</html>